  ...
  function toggleSideBar() {
    ...
    // Conditionally add or remove pl-60 and pl-56 classes
    if (!sidebar.classList.contains("hidden")) {
        header.classList.add("pl-60");
        main.classList.add("pl-56");
    } else {
        header.classList.remove("pl-60");
        main.classList.remove("pl-56");
    }
}
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Check if sidebar should initially be hidden
    if (sidebar.classList.contains("hidden")) {
        let main = document.querySelector('.main');
        let header = document.querySelector('.header');
