...
<form action="/store-member" enctype="multipart/form-data" method="post" role="form">
    @csrf
        <div class="mx-auto bg-white w-[97%] rounded-md shadow-md shadow-[#21351B] sm:w-[70%] lg:w-[50%]">
            <h1 class="text-center p-4 text-xl font-bold text-[#21351B]">MEMBER REGISTRATION</h1>
